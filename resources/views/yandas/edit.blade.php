<form action="{{ route('yandas.update', $yandas->id) }}" method="POST">
    ...
    <select name="Kategori" required>
        <option value="Arsip Dinamis" {{ $yandas->Kategori == 'Arsip Dinamis' ? 'selected' : '' }}>Arsip Dinamis
        </option>
        ...
        <option value="Arsip Permanen" {{ $yandas->Kategori == 'Arsip Permanen' ? 'selected' : '' }}>Arsip Permanen
        </option>
        <option value="Arsip Fisik" {{ $yandas->Kategori == 'Arsip Fisik' ? 'selected' : '' }}>Arsip Fisik</option>
        <option value="Arsip Retensi Jangka Pendek"
            {{ $yandas->Kategori == 'Arsip Retensi Jangka Pendek' ? 'selected' : '' }}>Arsip Retensi Jangka Pendek
        </option>
        <option value="Arsip Retensi Jangka Panjang"
            {{ $yandas->Kategori == 'Arsip Retensi Jangka Panjang' ? 'selected' : '' }}>Arsip Retensi Jangka Panjang
        </option>
        <option value="Arsip Elektronik" {{ $yandas->Kategori == 'Arsip Elektronik' ? 'selected' : '' }}>Arsip
            Elektronik</option>
    </select>
    <div>
