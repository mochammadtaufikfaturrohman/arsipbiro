...
<head>
    ...
    <link rel="icon" href="..." type="image/webp"> <!-- (Gunakan base64 asli Anda di sini) -->
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <!-- Notifikasi -->
                <div class="bg-danger text-light py-2 px-3">
                    <marquee behavior="scroll" direction="left" scrollamount="5">
                        🔔 <strong>Pemberitahuan:</strong> Silakan baca halaman ini terlebih dahulu untuk mengetahui jenis-jenis arsip yang tersedia.
                    </marquee>
                </div>
                ...
                <div class="container-fluid">
                    <div class="mb-4">
                        ...
                        <p class="mt-3">
                            Sistem Arsip Digital ini dirancang untuk membantu instansi dalam mengelola dokumen secara efisien dan terstruktur. Setiap dokumen perlu diklasifikasikan berdasarkan kategori yang telah ditentukan agar proses pencarian dan pengelolaan menjadi lebih mudah.
                        </p>
                        <p>
                            Panduan ini berisi penjelasan mengenai kategori arsip, contoh dokumen untuk setiap kategori, serta langkah-langkah penginputan yang benar.
                        </p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        $arsipList = [
                            ...
                            ['title' => 'Arsip Retensi Jangka Panjang', 'desc' => 'Disimpan untuk waktu lebih dari 5 tahun sebelum dimusnahkan atau dipindahkan.', 'slug' => 'retensi-panjang'],
                        ...
                        <div class="col-md-4">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('arsip.detail', ['jenis' => $arsip['slug']]) }}" class="btn btn-primary">Lihat Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
