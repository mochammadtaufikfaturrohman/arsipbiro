<form action="{{ route('bms.update', $bms->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <select name="Kategori" required>
        ...
        <option value="Arsip Permanen" {{ $bms->Kategori == 'Arsip Permanen' ? 'selected' : '' }}>Arsip Permanen</option>
        <option value="Arsip Retensi Jangka Pendek" {{ $bms->Kategori == 'Arsip Retensi Jangka Pendek' ? 'selected' : '' }}>Arsip Retensi Jangka Pendek</option>
        <option value="Arsip Retensi Jangka Panjang" {{ $bms->Kategori == 'Arsip Retensi Jangka Panjang' ? 'selected' : '' }}>Arsip Retensi Jangka Panjang</option>
        <option value="Arsip Elektronik" {{ $bms->Kategori == 'Arsip Elektronik' ? 'selected' : '' }}>Arsip Elektronik</option>
    </select>
